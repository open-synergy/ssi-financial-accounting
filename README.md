...
[ssi_account_statement_import_pdf_image](ssi_account_statement_import_pdf_image/) | 14.0.1.0.0 |  | Import bank statements from scanned/image-only PDF files using local OCR
